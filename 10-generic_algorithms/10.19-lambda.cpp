 ...
 * stable_sort(itBeg, itEnd, funcCompare)
 * partition(itBeg, itEnd, funcCompare)
 * stable_partition(itBeg, itEnd, funcCompare)
 */
#include <iostream>
#include <string>
#include <vector>
...
void Biggies(vector<string> &words, vector<string>::size_type sz)
{
	...
	auto itWords = stable_partition(words.begin(), words.end(),
...
int main(int argc, char **argv)
{
	vector<string> vecStr({
			...
			"6"});
	Biggies(vecStr, 3);
	// partition output:		567890 123456 223456 3456 
	// stable_partition output:	3456 223456 123456 567890 
