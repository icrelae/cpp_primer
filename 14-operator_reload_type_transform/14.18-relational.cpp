/* 2017.01.17 08:50
 * P_499
 * principle of reload relational operator: !!!
 * 1)	define sequence relation that consistent with associative-container's
 *	requirment for the key
 * 2)	if '==' have been customized, the logic of relational operator and '=='
 *	should be consistent:
 *	a) compare all of member or not
 *	b) the order of comparison
 * add:
 *	operator<(const StrVec&, const StrVec&)
 *	operator<(const StrBlob&, const StrBlob&)
