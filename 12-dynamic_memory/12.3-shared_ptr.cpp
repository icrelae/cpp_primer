/* 2016.12.29 08:35
 * P_407
 * const StrBlob should not change member's value, include members of members;
 * but if there's necessary to call push_back()/pop_back() for const StrBlob,
 * add const push_back()/pop_back() is also necessary because const object can
 * only call const functions
 */
#include <iostream>
#include <string>
#include <vector>
